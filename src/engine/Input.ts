class InputSystem {
    static Keys = new Set();
    static Events: Map<string, Array<Function>> = new Map();
    static EventsOnce: Map<string, Array<Function>> = new Map();
    ...
    static AddEventListener (key: string, handler: Function, once: boolean = false): void {
