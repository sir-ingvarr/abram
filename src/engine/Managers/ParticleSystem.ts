...
export type ParticleSystemOptions = {
    ...
    graphic?: ValueOrFunction<ImageWrapper | GraphicPrimitive<any, any>>,
...
class ParticleSystem extends ExecutableManager {
    ...
    protected graphic: Nullable<ValueOrFunction<ImageWrapper | GraphicPrimitive<any, any>>>;
    ...
    private CreateOrObtainParticle(): Particle {
        let particle;
        if(this.particleBuffering && this.buffer.length) {
            particle = this.buffer.pop()!;
