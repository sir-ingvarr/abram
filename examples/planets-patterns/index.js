document.addEventListener('DOMContentLoaded', async function() {
	...
	const planet5 = await engine.Instantiate(Planet, { radius: 5, rotateRadius: 35, speed: 0.003634, color: new RGBAColor(200, 100, 100), spritePath: './assets/sun.png' }, planet4Satellite.transform);
