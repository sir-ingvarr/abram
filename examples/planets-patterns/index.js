document.addEventListener('DOMContentLoaded', function() {
    ...
    const planet1 = new Planet({ radius: 25, rotateRadius: 110, speed: 0.002934, color: new RGBAColor(150, 20, 30) });
    engine.AppendGameObject(planet1);

    const planet2 = new Planet({ radius: 30, rotateRadius: 210, speed: 0.000334, color: new RGBAColor(0, 100, 30) });
    engine.AppendGameObject(planet2);

    const planet3 = new Planet({ radius: 15, rotateRadius: 320, speed: 0.001634, color: new RGBAColor(200, 100, 100) });
    ...
    const lines3 = new Lines({ planet1: planet3, planet2: planet4, limit: 10000 });
