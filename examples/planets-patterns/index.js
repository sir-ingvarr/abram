document.addEventListener('DOMContentLoaded', async function() {
	...
	await engine.Instantiate(Planet, { radius: 40, spritePath: './assets/sun.png', selfRotationSpeed: 1 });
	...
	const satellitePlanet3 = await engine.Instantiate(Planet, { radius: 7, rotateRadius: 30, speed: 0.0018934, color: new RGBAColor(200, 250, 250), spritePath: './assets/sattelite.png' }, planet3.transform);
	...
	const planet4Satellite = await engine.Instantiate(Planet, { radius: 9, rotateRadius: 45, speed: -0.002234, color: new RGBAColor(200, 100, 100), spritePath: './assets/planet1.png' }, planet4.transform);
	const planet5 = await engine.Instantiate(Planet, { radius: 5, rotateRadius: 35, speed: 0.001634, color: new RGBAColor(200, 100, 100), spritePath: './assets/sun.png' }, planet4Satellite.transform);
	const planet6 = await engine.Instantiate(Planet, { radius: 3, rotateRadius: 15, speed: -0.003634, color: new RGBAColor(200, 100, 100), spritePath: './assets/sun.png' }, planet5.transform);
	...
	await engine.Instantiate(Lines, { planet1: planet2, planet2: satellitePlanet3, limit: 10000 });
	await engine.Instantiate(Lines, { planet1: planet4, planet2: planet2, limit: 10000 });
	await engine.Instantiate(Lines, { planet1: planet4Satellite, planet2: planet5, limit: 10000 });
});
