async function GaltonScene(engine) {
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    engine.RegisterScene('galton', GaltonScene);
    engine.Start();
    await engine.LoadScene('galton');
    InputSystem.AddEventListener('Escape', () => engine.LoadScene('galton'));
});
